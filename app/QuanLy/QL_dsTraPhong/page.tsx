          ...
          <div className="mb-6 flex flex-wrap items-center justify-between rounded-md bg-primary/30 p-4">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                ...
                <option value="Đã hẹn">Đang chờ</option>
                <option value="Đang chờ">Đã hẹn</option>
              </select>
            </div>
          </div>
          {/* Danh sách */}
                  ...
                  <tr key={item.id}>
                    ...
                    <td className="border px-4 py-2">
                      <div className="relative inline-block" ref={dropdownRef}>
                        <button
                          className={`min-w-30 rounded-full px-4 py-1 text-sm font-medium text-white shadow-sm focus:outline-none ${item.status === "Đã hẹn" ? "bg-grey" : "bg-pink-500"}`}
                          onClick={() =>
                            setOpenDropdownId(
                        ...
                        {openDropdownId === item.id && (
                          <div className="absolute left-0 mt-2 w-40 bg-white border border-base rounded shadow z-10">
                            <button
                              ...
                              onClick={() =>
                                handleChangeStatus(item.id, "Đang chờ")
                              }
                            >
                              Đang chờ
                            </button>
